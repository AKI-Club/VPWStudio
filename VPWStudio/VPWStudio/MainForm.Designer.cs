namespace VPWStudio
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.toki1TestToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.moveAnimpropTestToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.moveAnimpropTesteditModeToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.splitModelTestToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			// 
			this.closeProjectToolStripMenuItem.Image = global::VPWStudio.Properties.Resources.MenuIcon16_Close;
			...
			// 
			this.titantronVideosToolStripMenuItem.Name = "titantronVideosToolStripMenuItem";
			resources.ApplyResources(this.titantronVideosToolStripMenuItem, "titantronVideosToolStripMenuItem");
			this.titantronVideosToolStripMenuItem.Click += new System.EventHandler(this.titantronVideosToolStripMenuItem_Click);
			// 
            ...
            this.gameSpecificInformationToolStripMenuItem,
            ...
            this.toki1TestToolStripMenuItem,
            ...
            this.moveAnimpropTestToolStripMenuItem,
            this.moveAnimpropTesteditModeToolStripMenuItem,
            ...
            this.codeSegmentTestToolStripMenuItem,
            this.splitModelTestToolStripMenuItem});
			...
			// 
			// toki1TestToolStripMenuItem
			// 
			this.toki1TestToolStripMenuItem.Name = "toki1TestToolStripMenuItem";
			resources.ApplyResources(this.toki1TestToolStripMenuItem, "toki1TestToolStripMenuItem");
			this.toki1TestToolStripMenuItem.Click += new System.EventHandler(this.toki1TestToolStripMenuItem_Click);
			// 
			...
			resources.ApplyResources(this.moveDamageTestToolStripMenuItem, "moveDamageTestToolStripMenuItem");
			this.moveDamageTestToolStripMenuItem.Click += new System.EventHandler(this.moveDamageTestToolStripMenuItem_Click);
			// 
			// moveAnimpropTestToolStripMenuItem
			// 
			this.moveAnimpropTestToolStripMenuItem.Name = "moveAnimpropTestToolStripMenuItem";
			resources.ApplyResources(this.moveAnimpropTestToolStripMenuItem, "moveAnimpropTestToolStripMenuItem");
			this.moveAnimpropTestToolStripMenuItem.Click += new System.EventHandler(this.moveAnimpropTestToolStripMenuItem_Click);
			// 
			// moveAnimpropTesteditModeToolStripMenuItem
			// 
			this.moveAnimpropTesteditModeToolStripMenuItem.Name = "moveAnimpropTesteditModeToolStripMenuItem";
			resources.ApplyResources(this.moveAnimpropTesteditModeToolStripMenuItem, "moveAnimpropTesteditModeToolStripMenuItem");
			this.moveAnimpropTesteditModeToolStripMenuItem.Click += new System.EventHandler(this.moveAnimpropTesteditModeToolStripMenuItem_Click);
			// 
			...
			// 
			// splitModelTestToolStripMenuItem
			// 
			this.splitModelTestToolStripMenuItem.Name = "splitModelTestToolStripMenuItem";
			resources.ApplyResources(this.splitModelTestToolStripMenuItem, "splitModelTestToolStripMenuItem");
			this.splitModelTestToolStripMenuItem.Click += new System.EventHandler(this.splitModelTestToolStripMenuItem_Click);
			// 
			// StatusBar
			// 
		...
		private System.Windows.Forms.ToolStripMenuItem toki1TestToolStripMenuItem;
		...
		private System.Windows.Forms.ToolStripMenuItem moveDamageTestToolStripMenuItem;
		...
		private System.Windows.Forms.ToolStripMenuItem splitModelTestToolStripMenuItem;
        private System.Windows.Forms.ToolStripMenuItem moveAnimpropTestToolStripMenuItem;
		private System.Windows.Forms.ToolStripMenuItem moveAnimpropTesteditModeToolStripMenuItem;
	}
}
