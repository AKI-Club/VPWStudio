...
namespace VPWStudio
{
	...
	public static class SharedStrings
	{
		...
		public static string FileLoadFilter_TextureI4 = "I4 Textures (*.i4tex)|*.i4tex|All Files (*.*)|*.*";
		...
		public static string FileLoadFilter_TextureTim = "TIM Files (*.tim, *.dat)|*.tim;*.dat|All Files (*.*)|*.*";
