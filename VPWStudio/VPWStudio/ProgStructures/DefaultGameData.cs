		...
		public static Dictionary<SpecificGame, DefaultLocationData> DefaultLocations = new Dictionary<SpecificGame, DefaultLocationData>()
		{
			...
			},
			{
				...
				new DefaultLocationData(new Dictionary<string, DefaultLocationDataEntry>(){
					...
					{ "WrestlerHeightTable", new DefaultLocationDataEntry(0x2F200, 20) },
...

			{
				...
				new DefaultLocationData(new Dictionary<string, DefaultLocationDataEntry>(){
					...
					{ "WrestlerDefaultCostumePointers", new DefaultLocationDataEntry(0x3F8B0, 424) },
			...
			#region WCW/nWo Revenge
			{
				...
				new DefaultLocationData(new Dictionary<string, DefaultLocationDataEntry>(){
					...
					{ "WrestlerDefaultCostumeDefs", new DefaultLocationDataEntry(0x36D04, 0x4A0) },
					{ "WrestlerDefaultCostumePointers", new DefaultLocationDataEntry(0x371A8, 360) },
			...
			},
			{
				...
				new DefaultLocationData(new Dictionary<string, DefaultLocationDataEntry>(){
					...
					{ "WrestlerDefaultCostumeDefs", new DefaultLocationDataEntry(0x34454, 0x4A0) },
					{ "WrestlerDefaultCostumePointers", new DefaultLocationDataEntry(0x348F8, 360) },
			...
			#region WWF No Mercy
			{
				...
				new DefaultLocationData(new Dictionary<string, DefaultLocationDataEntry>(){
					...
					// code seg defs
					{ "CodeSegDefs", new DefaultLocationDataEntry(0x53A40, 180)},
			...
			},
			{
				...
				new DefaultLocationData(new Dictionary<string, DefaultLocationDataEntry>(){
					...
					// code seg defs
					{ "CodeSegDefs", new DefaultLocationDataEntry(0x539A0, 180)},
			...
			},
			{
				...
				new DefaultLocationData(new Dictionary<string, DefaultLocationDataEntry>(){
					...
					// code seg defs
					{ "CodeSegDefs", new DefaultLocationDataEntry(0x538A0, 180)},
		...
		{
			{
				...
				new Dictionary<SpecificGame, int>()
				{
					...
					{ SpecificGame.NoMercy_Proto_NTSC_June2000, 0x0B8F },
...

			{
				...
				new Dictionary<SpecificGame, int>()
				{
					...
					{ SpecificGame.NoMercy_Proto_NTSC_June2000, 0x034B },
...

			{
				...
				new Dictionary<SpecificGame, int>()
				{
					...
					{ SpecificGame.NoMercy_Proto_NTSC_June2000, 0x0277 },
...

            {
				...
				new Dictionary<SpecificGame, int>()
				{
					...
					{ SpecificGame.NoMercy_Proto_NTSC_June2000, 0x006B },
...

			{
				...
				new Dictionary<SpecificGame, int>()
				{
					...
					{ SpecificGame.NoMercy_Proto_NTSC_June2000, 0x006C },
