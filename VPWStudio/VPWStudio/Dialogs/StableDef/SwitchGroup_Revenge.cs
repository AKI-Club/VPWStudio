...
namespace VPWStudio
{
	...
	/// </summary>
	public partial class SwitchGroup_Revenge : Form
	{
		/// <summary>
		/// Pointer of wrestler to move.
		/// </summary>
		public uint MoveWrestler;
		...
		public SwitchGroup_Revenge(uint _wres, int _curStable, SortedList<int, StableDefinition> _stables)
		{
			MoveWrestler = _wres;
			Stables = _stables;
