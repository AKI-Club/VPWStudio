namespace VPWStudio
{
	partial class SwapWrestler_Revenge
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.labelSwapWres1.Size = new System.Drawing.Size(230, 13);
			this.labelSwapWres1.TabIndex = 0;
			this.labelSwapWres1.Text = "Swapping Pointer {0:X8}, currently in Stable {1}";
			// 
			// SwapWrestler_Revenge
			// 
			...
			this.Name = "SwapWrestler_Revenge";
