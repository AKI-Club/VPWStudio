...
namespace VPWStudio
{
	...
	public class FileTable : IXmlSerializable
	{
		...
		#region Filetable Extract Script Write
		/* exporting a format for a bespoke toolset? well I never! */

		public void WriteExtractScript(StreamWriter sw)
		{
			sw.WriteLine(string.Format("# Filetable extraction list generated by VPW Studio v{0}", Assembly.GetExecutingAssembly().GetName().Version.ToString()));
